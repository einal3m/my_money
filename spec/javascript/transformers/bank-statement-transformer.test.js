import bankStatementTranformer from "transformers/bank-statement-transformer";
...
describe("BankStatementTranformer", () => {
  describe("transformFromApi", () => {
    it("converts bank statements from API format", () => {
      ...
      const transformedBankStatement =
        bankStatementTranformer.transformFromApi(bankStatementFromApi);
