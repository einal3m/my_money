...
RSpec.describe TransactionType, type: :model do
  it 'Share Purchase' do
    ...
    expect(transaction_type.code).to eq('purchase')
  ...
  it 'Share Dividend' do
    ...
    expect(transaction_type.code).to eq('dividend')
  ...
  it 'Unit Price Update' do
    ...
    expect(transaction_type.code).to eq('unit_price_update')
  ...
  it 'Share Sale' do
    ...
    expect(transaction_type.code).to eq('sale')
  ...
  it 'Bank Transaction' do
    ...
    expect(transaction_type.code).to eq('bank_transaction')
