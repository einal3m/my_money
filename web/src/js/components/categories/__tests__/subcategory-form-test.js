...
describe('SubcategoryForm', () => {
  ...
  describe('isValid', () => {
    it('returns true if all fields are valid', () => {
      const form = TestUtils.renderIntoDocument(<SubcategoryForm subcategory={subcategory} groupedCategories={groupedCategories} />);
  ...
  describe('updating state and validation', () => {
    it('updates state and validates name is required', () => {
      const form = TestUtils.renderIntoDocument(<SubcategoryForm subcategory={{}} groupedCategories={groupedCategories} />);
