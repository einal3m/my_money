...
describe('CategoryTypeTable', () => {
  let categories, categoryType, editCategorySpy, editSubcategorySpy, categoryTypeTable, subcategories;
  beforeEach(() => {
    subcategories = [{id: 12, name: 'Subcategory1', categoryId: 22}, {id: 22, name: 'Two', categoryId: 22}]
    categories = [
      {id: 11, name: 'Category One', subcategories: []}, 
      {id: 22, name: 'Category Two', subcategories: subcategories}
    ];
  ...
  describe('render', () => {
    it('displays a title and a table of categories', () => {
      ...
      let category0 = categoryRows[0][0];
      let category1 = categoryRows[1][0];
      let cat1subs = categoryRows[1][1];
