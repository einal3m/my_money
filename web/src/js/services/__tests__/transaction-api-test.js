...
describe('transactionApi', () => {
  ...
  describe('list', () => {
    ...
    it('has a description parameter if provided', () => {
      transactionApi.index(34, '2015-09-03', '2015-10-02', 'Melanie');

      let requestParams = transactionApi._send.calls.argsFor(0)[0];
      expect(requestParams.url).toEqual('http://localhost:3000/accounts/34/transactions?from_date=2015-09-03&to_date=2015-10-02&description=Melanie');
    });
  });
});
