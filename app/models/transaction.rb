...
class Transaction < ApplicationRecord
  ...
  def match_transaction
    ...
    matching_transaction.update_column(:matching_transaction_id, id) # rubocop:disable Rails/SkipsModelValidations
  end
  ...
  def unmatch_transactions
    ...
    old_matching_transaction.update_column(:matching_transaction_id, nil) # rubocop:disable Rails/SkipsModelValidations
  end
  ...
  def update_balance_for_following(from_date, new_balance)
    account.transactions.where('date >= ?', from_date).date_order.each do |t|
      ...
      t.update_column(:balance, new_balance) # rubocop:disable Rails/SkipsModelValidations
    end
  end
